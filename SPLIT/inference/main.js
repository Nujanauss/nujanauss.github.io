        ...
        switch(pageId) {
            ...
            case 'GAME3':
                loadPhase3(
                  ...
                  false,
                  {
                    ...
                    nextPage:            (currentPlayer > 2) ? 'THANKS_PRE' : 'INSTRUCTIONS1_P4',
            ...
            case 'RATEOTHER':
                loadRate(true,
                  ...
                  nextPage:     (currentPlayer > 2) ? 'THANKS' : 'INSTRUCTIONS2_P4',
...
function loadInstructions2() {
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS2'));
  buttonToNewPage('nextButton2', 'INSTRUCTIONS3', wordCnt);
}

function loadInstructions3() {
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS3'));
  buttonToNewPage('backButton3', 'INSTRUCTIONS2', wordCnt);
  buttonToNewPage('trainingButton', 'TRAIN', wordCnt);
}

function loadInstructions4() {
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS4'));
  buttonToNewPage('nextButton4', 'INSTRUCTIONS5', wordCnt);
}

function loadInstructions5() {
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS5'));
  buttonToNewPage('backButton5', 'INSTRUCTIONS4', wordCnt);
  buttonToNewPage('trainingButton2', 'TRAIN2', wordCnt);
}
...
function loadInstructions8() {
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS8'));
  buttonToNewPage('nextButton8', 'INSTRUCTIONS9', wordCnt);
}

function loadInstructions9() {
  document.getElementById('bonusMention').innerHTML = "£" + MB3;
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS9'));
  buttonToNewPage('backButton9', 'INSTRUCTIONS8', wordCnt);
  buttonToNewPage('nextButton9', 'INSTRUCTIONS10', wordCnt);
}

function loadInstructions10() {
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS10'));
  buttonToNewPage('backButton10', 'INSTRUCTIONS2', wordCnt);
  buttonToNewPage('nextButton10', 'CHECK', wordCnt);
}
...
function loadInstructions1_P2() {
  ...
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS1_P2'));
  document.getElementById('phase-1-score').innerHTML = totalScore;
  buttonToNewPage('nextButton21', 'RATESELF', wordCnt);
}

function loadInstructions2_P2() {
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS2_P2'));
  buttonToNewPage('nextButton22', 'INSTRUCTIONS9_P2', wordCnt);
}
...
function loadInstructions3_P2() {
  ...
  if (!targetName.includes('Expert')) {
    document.getElementById('expert_caveat').innerHTML = "";
  } else {
    document.getElementById('expert_caveat').innerHTML = "Unlike you, Expert Player can see the value of the cards before selecting them. Though Expert Player is not perfect.";
  }
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS3_P2'));
  buttonToNewPage('nextButton23', 'INSTRUCTIONS4_P2', wordCnt);
}
...
function loadInstructions4_P2() {
  ...
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS4_P2'));
  buttonToNewPage('backButton24', 'INSTRUCTIONS3_P2', wordCnt);
  buttonToNewPage('nextButton24', 'GAME2', wordCnt);
}
...
function loadInstructions9_P2() {
  ...
  let onceOnly = document.getElementById('only-needed-once');
  if (currentPlayer == 1) {
  ...
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS9_P2'));
  buttonToNewPage('backButton29', 'INSTRUCTIONS2_P2', wordCnt);
  buttonToNewPage('nextButton29', 'SELECT_PARTNER', wordCnt);
}


function loadInstructions2_P3() {
  document.getElementById('target2_P3').innerHTML = targetName;
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS2_P3'));
  buttonToNewPage('nextButton32','INSTRUCTIONS3_P3', wordCnt);
}

function loadInstructions2_P3_REPEAT() {
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS2_P3_REPEAT'));
  buttonToNewPage('nextButton32R','INSTRUCTIONS3_P3_REPEAT', wordCnt);
}
...
function loadInstructions3_P3() {
  ...
  buttonToNewPage('nextButton33','INSTRUCTIONS4_P3', wordCnt);
}
...
function loadInstructions3_P3_REPEAT() {
  ...
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS3_P3_REPEAT'));
  buttonToNewPage('backButton33R','INSTRUCTIONS2_P3_REPEAT', wordCnt);
  buttonToNewPage('nextButton33R','INSTRUCTIONS11_P3', wordCnt);
}
...
function loadInstructions5_P3() {
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS5_P3'));
  buttonToNewPage('backButton35','INSTRUCTIONS4_P3', wordCnt);
  buttonToNewPage('nextButton35','INSTRUCTIONS6_P3', wordCnt);
}
...
function loadInstructions6_P3() {
  ...
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS6_P3'));
  buttonToNewPage('backButton36','INSTRUCTIONS5_P3', wordCnt);
  buttonToNewPage('nextButton36','TRAIN_P3', wordCnt);
}
...
function loadInstructions7_P3() {
  ...
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS7_P3'));
  buttonToNewPage('nextButton37','INSTRUCTIONS8_P3', wordCnt);
}

function loadInstructions8_P3() {
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS8_P3'));
  buttonToNewPage('backButton38','INSTRUCTIONS7_P3', wordCnt);
  buttonToNewPage('nextButton38','INSTRUCTIONS10_P3', wordCnt);
}

function loadInstructions9_P3() {
  document.getElementById('target9_P3').innerHTML = targetName;
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS9_P3'));
  buttonToNewPage('backButton39','INSTRUCTIONS8_P3', wordCnt);
  buttonToNewPage('nextButton39','INSTRUCTIONS10_P3', wordCnt);
}

function loadInstructions10_P3() {
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS10_P3'));
  buttonToNewPage('backButton310','INSTRUCTIONS3_P3', wordCnt);
  buttonToNewPage('nextButton310','CHECK_P3', wordCnt);
}
...
function loadInstructions1_P4() {
  sessionStorage.setItem("honeypotFilled", false)
  document.getElementById("company")?.addEventListener("input", () =>
    sessionStorage.setItem("honeypotFilled", true)
  );

  document.getElementById('target1_P4').innerHTML = targetName;
  document.getElementById('target1_P4_2').innerHTML = targetName;
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS1_P4'));
  buttonToNewPage('nextButton41', 'RATEOTHER', wordCnt);
}
...
function loadInstructions2_P4() {
  ...
  phase3Round++;
  phase4Round++;
  const wordCnt = countWordsFromHTML(document.getElementById('INSTRUCTIONS2_P4'));
  buttonToNewPage('nextButton42','INSTRUCTIONS9_P2', wordCnt);
}
...
async function loadPhase2(numberOfMoves, numberOfRounds, historyRowNum, training, ids) {
    ...
    function saveData(decisionArr, timeArr) {
      ...
      sessionStorage.setItem("Stage2Round" + currentPlayer, JSON.stringify(data));
    }
...
function loadPhase3(numberOfMoves, numberOfRounds, comparisonFrequency, training, ids) {
    ...
    let   comparisonSelected = Array(numberOfMoves);
    let   rewardReceived     = Array(numberOfMoves);
    let   comparisonValue    = Array(numberOfMoves).fill(NaN);
    let   iconDropped        = Array(numberOfMoves);
    let   iconCorrect        = Array(numberOfMoves);
    ...
    function mouseDownDrag(e, img, pickUpSquares) {
      ...
      function mouseUpHandler(upEvent) {
        ...
        pickUpSquares.forEach(square => {
          ...
          if (inside && !dropped) {
            const x = +square.dataset.x;
            let isCorrect = checkCorrect(x);
            if (isCorrect) {
              correctCount++;
            }
            iconDropped[currentTrial-comparisonFrequency+dropCounter] = x;
            iconCorrect[currentTrial-comparisonFrequency+dropCounter] = isCorrect;
    ...
    function checkCorrect(x) {
      ...
      for (let idx = 0; idx < comparisonFrequency; idx++) {
    ...
    function handleClick(square) {
      ...
      comparisonSelected[currentTrial] = agent[`round_${round}`]?.[currentTrial]?.decision;
      const pseudo = square.firstElementChild;
      const scoreDisp = pseudo.querySelector('[data-type="score"]');
    ...
    function submitGuess() {
      ...
      if (currentTrial >= numberOfMoves - 1) {
        ...
        saveData(cardSelected, comparisonSelected, rewardReceived, iconDropped, iconCorrect, comparisonValue, timeStampsSelected, timeStampsDropped);
        Array.from(rowWrapper.querySelector(`.subrow`).children).forEach(sq => {sq.classList.add('grey');});
    ...
    function saveData(cardSelectedArr, comparisonDecisionArr, rewardReceivedArr, iconDroppedArr, iconCorrectArr, comparisonValue, timeStampsSelectedArr, timeStampsDroppedArr) {
      const data = {};
      cardSelectedArr.forEach((sq, idx) => {
        data[idx] = {
          decision: sq,
          comparisonDecision: comparisonDecisionArr[idx],
          ...
          iconCorrect: iconCorrectArr[idx],
...
function loadCheck() {
    check1Entered++;
    buttonToNewPage('backButton_check1', 'INSTRUCTIONS2'); // Always available
    wrongCount = 0;
...
function loadCheck_P3() {
    check3Entered++;
    wrongCount_P3 = 0;
    buttonToNewPage('backButton_check3','INSTRUCTIONS3_P3'); // Always available
    ...
    submitButton.onclick = () => {
      ...
      sessionStorage.setItem('checkQuestions_P3', JSON.stringify(checkQuestions));
    };
}
...
function loadSelectObservationTarget() {
    ...
    if (currentPlayer == 1) {
      ...
      sessionStorage.setItem("ComparisonTargets", JSON.stringify(players));
      //players.reverse();
    }
...
function loadRate(otherRating, ids) {
    ...
    nextButton.onclick = (e) => {
      ...
      if (!ratedSelfOnce) {
        addRatingToSession('selfRating-1', val);
        ratedSelfOnce = true;
      } else if (otherRating) {
        addRatingToSession(targetName + '-rating', val);
      } else {
        addRatingToSession('selfRating-' + (currentPlayer + 1), val);
      }
    ...
    // Vertical Line
    if (otherRating || ratedSelfOnce) {
      const vertical   = otherRating ? document.getElementById('vertical-line') : document.getElementById('vertical-line-again');
      const fixedLabel = otherRating ? document.getElementById('rate-label-fixed') : document.getElementById('rate-label-fixed-again');
    ...
    function updateSliderBackground() {
      if (!otherRating && !ratedSelfOnce) return;
...
function addRatingToSession(key, value) {
    // Get the existing ratings object from sessionStorage
    let ratings = sessionStorage.getItem('ratings');

    // If it exists, parse it; otherwise start with an empty object
    ratings = ratings ? JSON.parse(ratings) : {};

    // Add/update the new rating
    ratings[key] = value;
...
function loadThanks_Pre() {
    document.getElementById('final_player').innerHTML = targetName;
    buttonToNewPage('nextButtonRateAgain_Final','RATEOTHER');
}
...
function countWordsFromHTML(html) {
  ...
  if (typeof html === 'string') {
    ...
    // html is already a DOM node
    text = html.textContent || '';
  } else {
    // fallback: convert to string (avoid "[object ...]" being counted)
    text = String(html);
  }
...
function buttonToNewPage(buttonId, newPageID, wordCnt=null) {
    ...
    const handler = function() {
      addToInstructionTimings(buttonId, new Date().toISOString().split('T')[1], wordCnt);
      showPage(newPageID);
    };
...
function addToInstructionTimings(buttonId, timestamp, wordCnt=null) {
